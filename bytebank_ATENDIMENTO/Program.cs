...
void TestaArrayContasCorrentes()
{
    ...
    listaDeContas.Adicionar(new ContaCorrente(874, "123458-X"));
    listaDeContas.Adicionar(new ContaCorrente(874, "123459-X"));
    listaDeContas.Adicionar(new ContaCorrente(874, "123410-X"));
    listaDeContas.Adicionar(new ContaCorrente(874, "123411-X"));
    listaDeContas.Adicionar(new ContaCorrente(874, "123412-X"));
    listaDeContas.Adicionar(new ContaCorrente(874, "123413-X"));
    listaDeContas.Adicionar(new ContaCorrente(874, "123414-X"));

    var contaDoAndre = new ContaCorrente(963, "123414-X");
...
{
    new ContaCorrente(95, "123420-X") {Saldo=100},
    new ContaCorrente(95, "123421-X") {Saldo=200},
    new ContaCorrente(94, "123422-X") {Saldo=60}
}; ;
